...
if (isset($_POST['enviar'])) {
    ...
    $consulta->prepare('INSERT INTO usuarios (nombre, contrasena, apellidos, correo, telefono, repetida) 
    values (?,?,?,?,?,?)');
    ...
    $validacion_nombre = $validacion_apellidos = $validacion_correo = $validacion_telefono = $validacion_contrasena =
        ...
        <div class="col-9 col-sm-8"><br>
            ...
            <div class="cuerpo">
                <div class="row"><br>
                    <div class="col-2"> </div>
                    <div class="col-9"><br>
                        <h5>Date de alta, y viajar será otra cosa</h5>
                        <ul>
                            <li>Benefíciate de un trato preferencial con prioridad en listas de espera y embarque</li>
                            <li>Guarda tus datos personales y de vuelo para ahorrar tiempo al hacer tu reserva.</li>
                            <li>Accede a precios especiales en primicia y descuentos exclusivos.</li>
                            <li>Acumula Avios que podrás canjear por descuentos en vuelos y planes de ocio.</li>
                        </ul>
                        <br>
                        <?php echo $resultado; ?>
