...
if ($resultado = $mysqli->query('SELECT * FROM carrito WHERE id="' . $id . '"')) {
    while ($fila = $resultado->fetch_assoc()) {
        $cantidad_selec = $fila['cantidad'];
        $usuarioCarrito_selec = $fila['usuarioCarrito'];
...
if (isset($_POST['enviar'])) {
    ...
    $consulta->prepare('UPDATE carrito SET cantidad=?,usuarioCarrito=?, pais=?, clase=?, precio=?, fecha_ida=?, fecha_vuelta=?, compania=?,codigo=? WHERE id=?');
    ...
    if ($validacion_usuarioCarrito == true && $validacion_cantidad == true && $validacion_compania == true && $validacion_pais == true && $validacion_codigo == true && $validacion_clase == true && $validacion_precio == true && $validacion_fecha_ida == true && $validacion_fecha_vuelta == true) {
        $consulta->bind_param('isssssssss', $cantidad, $usuarioCarrito, $pais, $clase, $precio, $fecha_ida, $fecha_vuelta, $compania, $codigo, $id);
                    ...
                    <div class="col-9"><br>
                        ...
                        <form action="" method="post">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <input type="text" name="nombreUsuario" value="<?php echo $usuarioCarrito_selec ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12  col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <input type="number" name="cantidad" value="<?php echo $cantidad_selec ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12  col-md-6">
