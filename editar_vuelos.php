...
$fecha_ida_selec = "";
$fecha_vuelta_selec = "";
if ($resultado = $mysqli->query('SELECT * FROM vuelos WHERE id="' . $id . '"')) {
    while ($fila = $resultado->fetch_assoc()) {
        $compania_selec = $fila['compania'];
        $pais_selec = $fila['pais'];
        $codigo_selec = $fila['codigo'];
        $precio_selec = $fila['precio'];
        $clase_selec = $fila['clase'];
        $fecha_ida_selec = $fila['fecha_ida'];
        $fecha_vuelta_selec = $fila['fecha_vuelta'];
    }
}
...
if (isset($_POST['enviar'])) {
    ...
    $consulta->prepare('UPDATE vuelos SET pais=?, clase=?, precio=?, fecha_ida=?, fecha_vuelta=?, 
    compania=?,codigo=? WHERE id=?');
    ...
    $validacion_compania = $validacion_pais = $validacion_codigo = $validacion_precio = $validacion_clase
        = $validacion_fecha_ida = $validacion_fecha_vuelta = false;
    ...
    if (
        $validacion_compania == true && $validacion_pais == true && $validacion_codigo == true && $validacion_clase
        == true && $validacion_precio == true && $validacion_fecha_ida == true && $validacion_fecha_vuelta == true
    ) {
        $consulta->bind_param('ssssssss', $pais, $clase, $precio, $fecha_ida, $fecha_vuelta, $compania, $codigo, $id);
        $consulta->execute();
        $consulta->close();
        $conexion->close();
        header('Location:parteAdmin.php?usuario=' . session_name() . '');
                    ...
                    <div class="col-9"><br>
                        ...
                        <form action="" method="post">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <input type="text" name="compania" value="<?php echo $compania_selec ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12  col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <input type="text" name="pais" value="<?php echo $pais_selec ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12  col-md-6">
                                ...
                                <div class="col-12 col-md-6">
                                    <input type="text" name="clase" value="<?php echo $clase_selec ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12  col-md-6">
                                ...
                                <div class="col-12 col-md-6">
                                    <input type="text" name="precio" value="<?php echo $precio_selec ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12  col-md-6">
                                ...
                                <div class="col-12 col-md-6">
                                    <input type="date" name="fecha_ida" value="<?php echo $fecha_ida_selec ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12  col-md-6">
                                ...
                                <div class="col-12 col-md-6">
                                    <input type="date" name="fecha_vuelta" value="<?php echo $fecha_vuelta_selec ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12  col-md-6">
