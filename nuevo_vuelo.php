...
if (isset($_POST['enviar'])) {
    ...
    $consulta->prepare('INSERT INTO vuelos ( pais, clase, precio, fecha_ida, fecha_vuelta, compania,codigo) 
    VALUES (?,?,?,?,?,?,?)');
    ...
    $validacion_compania = $validacion_pais = $validacion_codigo = $validacion_precio = $validacion_clase = $validacion_fecha_ida = $validacion_fecha_vuelta = false;
    ...
    if (
        ...
        $consulta->bind_param('sssssss', $pais, $clase, $precio, $fecha_ida, $fecha_vuelta, $compania, $codigo);
        $consulta->execute();
        $consulta->close();
        $conexion->close();
        header('Location:parteAdmin.php?usuario=' . session_name() . '');
